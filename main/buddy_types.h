...
typedef enum {
    BUDDY_PAGE_PROFILE,
    BUDDY_PAGE_HOME = BUDDY_PAGE_PROFILE,
    BUDDY_PAGE_STATUS = BUDDY_PAGE_PROFILE,
    BUDDY_PAGE_LINKS,
    BUDDY_PAGE_SETTINGS = BUDDY_PAGE_LINKS,
    BUDDY_PAGE_FOCUS,
    BUDDY_PAGE_PET = BUDDY_PAGE_FOCUS,
    BUDDY_PAGE_HEAT,
    BUDDY_PAGE_INFO = BUDDY_PAGE_HEAT,
    BUDDY_PAGE_STAMPS,
    BUDDY_PAGE_TRANSCRIPT = BUDDY_PAGE_STAMPS,
    BUDDY_PAGE_CC,
    BUDDY_PAGE_CODEX,
    BUDDY_PAGE_COUNT,
} buddy_page_t;
